...
ForeCache~\cite{Battle:2015:VLDB} utilizes a predictive prefetching strategy by learning a user's interaction patterns and prefetching data from the server to support real-time visual data exploration. 
